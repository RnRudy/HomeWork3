...
public class Main {
    ...
    public static void task7() {
        ...
        //если он теряет от 250 до 500 гр в день, то:
        System.out.println("Спортсмену понадобится в среднем " + (float)excessWeight2/((weightLose1+weightLose2)/2) + " дней, чтобы добиться результата похудения.");
